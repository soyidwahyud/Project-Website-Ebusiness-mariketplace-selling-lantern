...
<html>
  <head>
    ...
    <title>Add Tabel Products</title>
              ...
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <div class="form-group-material">
                      <input id="product_code" type="text" name="product_code"class="input-material">
                      <label for="product_code" class="label-material">Product Code</label>
                    </div>

                    <div class="form-group-material">
                      <input id="product_name" type="text" name="product_name" class="input-material">
                      <label for="product_name" class="label-material">Product Name</label>
                    </div>

                    <div class="form-group-material">
                      <input id="product_img_name" type="file" name="product_img_name"class="input-material">
                      <label for="product_img_name" class="label-material">Product image</label>
                    </div>
                    ...
                    <div class="form-group-material">
                      <input id="price" type="text" name="price" class="input-material">
