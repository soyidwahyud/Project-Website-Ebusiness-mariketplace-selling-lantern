<?php
   ...
   if(isset($_POST["cari"]))
  {
    $orders=cariOrders($_POST["keyword"]);  
  } 
?>
<!DOCTYPE html>
<html>
							   ...
							   <div class="container-fluid">
							       <div class="row">
							        ...
							        <div class="block margin-bottom-sm">
							          <div class="title"><strong>Tabel Orders</strong></div>
                                      ...
                                      <td>
                                      <a href="hapus_orders.php?orders=<?php echo $row["id"]; ?>"onclick="return confirm('Are you sure?')" class="aksi">Delete</a>
                                      </td>
