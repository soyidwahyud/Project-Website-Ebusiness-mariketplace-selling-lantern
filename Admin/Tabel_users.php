      ...
      <nav class="navbar navbar-expand-lg">
        <div class="search-panel">
          <div class="search-inner d-flex align-items-center justify-content-center">
            ...
            <form id="searchForm" action="" method="post" class="cari3">
							   ...
							   <div class="container-fluid">
							       <div class="row">
							        ...
							        <div class="block margin-bottom-sm">
							          <div class="title"><strong>Tabel Users</strong></div>
                                      ...
                                      <td>
                                      <a href="hapus_users.php?users=<?php echo $row["id"]; ?>"onclick="return confirm('Are you sure?')" class="aksi">Delete</a>
                                    </td>
						                        </tr>
						                        <?php }?>
					                    	</tbody>
