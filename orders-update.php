  ...
  foreach($_SESSION['cart'] as $product_id => $quantity) {
    ...
    if($result){
      ...
      if($obj = $result->fetch_object()) {
        ...
        $query = $mysqli->query("INSERT INTO orders(product_code, product_name, price, units, total, email, nama, alamat, kota, postcode, notelp, payment)
        VALUES('$obj->product_code', '$obj->product_name', '$obj->price', '$quantity', '$cost', '$user','$nama','$alamat','$kota','$postcode','$notelp','$payment')");
        ...
        // send email
        //mail("soyidwahyu4@gmail.com","My subject",$msg);
